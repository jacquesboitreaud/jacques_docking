...
""" 
Docking functions adapted to reach pre-computed scoring grids (run-independent-paths)
"""
...
calculate_rmsd                                               yes
use_rmsd_reference_mol                                       /home/mcb/jboitr/data/ligands/library.mol2
...
internal_energy_rep_exp                                      12
internal_energy_cutoff                                       100.0
ligand_atom_file                                             {add_suffix_new_path(pdb_path, write_dir, '.lig.min_scored.mol2')} 
limit_max_ligands                                            no
skip_molecule                                                no
read_mol_solvation                                           no
calculate_rmsd                                               yes
